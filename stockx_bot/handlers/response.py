...
import telegram
from telegram import Chat, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update, Message
...
async def send_photo_response(update: Update,
                              context: ContextTypes.DEFAULT_TYPE,
                              response: str,
                              photo: str | BytesIO,
                              keyboard: InlineKeyboardMarkup | ReplyKeyboardMarkup | None = None) -> Message:
    args = {
        "chat_id": _get_chat_id(update),
        "photo": photo,
        "caption": response,
